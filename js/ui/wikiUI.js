...
const WIKI = {
    ...
    ARTICLES: {
        ...
        finance: {
            title: 'Банк 2.0, Налоги и Корпоративные Финансы',
            subtitle: 'Залоговое кредитование, плавающие ставки, овердрафт и скоринг',
            content: `
                <div style="background: rgba(231,76,60,0.06); border-left: 4px solid #e74c3c; padding: 14px; border-radius: 8px; margin-bottom: 20px;">
                    <h4 style="margin: 0 0 6px 0; color: #e74c3c;">⚠️ Бизнес-Овердрафт и Ликвидность:</h4>
                    <p style="margin: 0; font-size: 0.92em; color: var(--text);">Следите за оттоком средств. Если баланс уйдет в минус, активируется жесткий Бизнес-Овердрафт (штраф 0.2% в день), а кредитный рейтинг стремительно обвалится.</p>
                </div>

                <h3 style="color: var(--text);">1. Залоговый лимит кредитования</h3>
                <p>Банк не выдает деньги просто так. Доступный кредитный лимит рассчитывается строго под обеспечение (залог) ваших активов:</p>
                <ul>
                    <li><strong>Депозиты (Вклады):</strong> покрывают 90% лимита (самый надежный актив).</li>
                    <li><strong>Недвижимость и Заводы:</strong> покрывают 70% стоимости (здания и станки).</li>
                    <li><strong>Товары и Сырье:</strong> покрывают 50% стоимости запасов на складах.</li>
                    <li><strong>Свободные наличные:</strong> дают 50% в лимит (на всякий случай).</li>
                </ul>

                <h3 style="color: var(--text); margin-top: 20px;">2. Плавающая ставка и Кредитный Рейтинг (Скоринг)</h3>
                <p>Кредитный скоринг (0 - 1000) теперь живой и динамичный. Базовая ставка ЦБ — 12%, а финальная ставка зависит от премии за риск:</p>
                <ul>
                    <li><strong>Рейтинг 800+ (Надежный заемщик):</strong> ставка снижается до 13%.</li>
                    <li><strong>Рейтинг < 300 (Высокий риск):</strong> ставка взлетает до 35% годовых.</li>
                </ul>
                <p>Скоринг плавно стремится к целевому значению. Он растет, если вы вовремя обслуживаете долги и накапливаете капитал. И стремительно падает при кассовых разрывах или высокой закредитованности.</p>

                <h3 style="color: var(--text); margin-top: 20px;">3. Долговая нагрузка (Debt/Equity или D/E)</h3>
                <p>Отношение всех ваших кредитов к чистым активам компании. Если <strong>D/E превышает 1.0</strong> (долгов больше, чем активов), банк считает вас потенциальным банкротом, целевой рейтинг падает на -300 пунктов, и получить новые кредиты становится невозможно.</p>

                <h3 style="color: var(--text); margin-top: 20px;">4. Налоговая система</h3>
                <ul>
                    <li><strong>Корпоративный налог на прибыль (18%):</strong> Уплачивается с чистой прибыли. Если день в убыток — налог 0.</li>
                    <li><strong>Единый социальный взнос на ФОТ (22%):</strong> Начисляется поверх зарплат ваших сотрудников.</li>
                </ul>
            `
        },
